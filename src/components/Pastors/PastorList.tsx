...
const PastorList = () => {
    ...
    const cardList = React.Children.toArray(data.map((list: IPastor) => {
        return (
  ...
  return (
    ...
    {screen < 801 ? <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column'}}>{React.Children.toArray(data.map((list: IPastor) => {
        return (
                <Card
